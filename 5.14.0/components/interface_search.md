...
| opensearch.dcat.basequery  `(Ab Version 5.14.7)` | Basis Filterung für den DCAT-AP.de Export, gilt zusätzlich zu der Abfrage aus dem Query-Parameter `q`. Default: `datatype:metadata (t04_search.searchterm:opendata OR t04_search.searchterm:opendataident)` |
