...
- [Bug] webmap client: "Erstelle pdf für Druck" funktioniert nicht ([REDMINE-8238](https://redmine.informationgrid.eu/issues/8238))
...
- [Feature] ISO-Import mit Codelist-IDs und Values ([REDMINE-8119](https://redmine.informationgrid.eu/issues/8119))
- [Bug] Wiedervorlage E-Mail muss aus Profil genommen werden ([REDMINE-8072](https://redmine.informationgrid.eu/issues/8072))
- [Bug] Migration kann zu falschen Datensatzänderungen führen ([REDMINE-8050](https://redmine.informationgrid.eu/issues/8050))
- [Bug] Importer liest aus den Adressen kein Telefon/Fax? ([REDMINE-7991](https://redmine.informationgrid.eu/issues/7991))

Profil LfU Bayern

- [Feature] E-Mail über abgelaufene Metadaten anpassen ([REDMINE-7785](https://redmine.informationgrid.eu/issues/7785))
- [Bug] Eintrag "WMS-URL"  bzw. "Dienste-URL" im Anwendungsprofil ist verloren gegangen ([REDMINE-8082](https://redmine.informationgrid.eu/issues/8082))
